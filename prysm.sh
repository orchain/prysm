...
if [[ $1 == slasher ]]; then
    color "41" "The slasher binary is no longer available. Please use the --slasher flag with your beacon node. See: https://prysm.offchainlabs.com/docs/configure-prysm/slasher/"
    exit 1
fi
